...
public class TelaDisciplina2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_disciplina2);
        ...
        setupButton(R.id.button_biologia, "Biologia");
        setupButton(R.id.button_educacao_fisica, "Educação Física");
        setupButton(R.id.button_filosofia, "Filosofia");
        setupButton(R.id.button_fisica, "Física");
        setupButton(R.id.button_quimica, "Química");
        setupButton(R.id.button_sociologia, "Sociologia");
